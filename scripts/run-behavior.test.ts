...
describe("behavior scenarios", () => {
  ...
  test("includes bounded-return-fix, post-success-stop, scan-code-yaml-recovery, search-files-no-match-recovery, two-file-deps-rename, scoped-edit-code-rename, scoped-edit-code-rename-shorthand, class-field-edit-code-rename, and structured-edit-code-replace scenarios", () => {
