...
- **Tool guards.** Seven behavioral guards detect and block degenerate model patterns at runtime — duplicate calls, file churn loops, redundant searches, and more.
