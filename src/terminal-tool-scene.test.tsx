...
test("semantic tool scene preserves legacy tool text and uses lifecycle markers", () => {
  ...
  const active: TranscriptRow = { ...presentation, lifecycle: "success" };
  expect(
    renderPlain(<ChatTranscriptRow row={row} contentWidth={30} toolContentWidth={30} presentation={active} />, 32),
  ).toStartWith("◉ Edit");
});
