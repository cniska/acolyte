export const EN_MESSAGES = {
  ...
  "cli.help.desc.auth": "authenticate a provider with a subscription",
  ...
  "cli.auth.logout": "Disconnected {provider} subscription.",
  "cli.auth.logout_none": "No {provider} subscription connected.",
  "cli.auth.invalid_provider": "Invalid provider: {provider}. Use openai.",
  "cli.auth.status.none": "No subscriptions connected. Connect one with: acolyte auth openai",
  "cli.auth.status.connected": "{provider}: connected.",
  ...
  "cli.init.override.cancelled": "Left the existing key unchanged.",
  "cli.init.override.confirm": "{envKey} is already set. Replace it? [y/N]: ",
  "cli.init.prompt.api_key": "API key: ",
  "cli.init.prompt.provider": "Provider [vercel|anthropic|google|openai]: ",
  "cli.init.provider.invalid": "Invalid provider. Use vercel, anthropic, google, or openai.",
  ...
  "status.label.active_skill": "Active skill",
