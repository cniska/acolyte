export const EN_MESSAGES = {
  ...
  "chat.model.usage": "Usage: /model <id> | /model <work|verify> <id>",
  ...
  "chat.picker.title.model.mode": "Model ({mode})",
  ...
  "cli.tool.edit-file.invalid_args": "Invalid edit args",
  "cli.tool.edit-file.usage": "Usage: /edit <path> <find> <replace> [--dry-run]",
  "cli.tool.failed": "Tool command failed",
  "cli.tool.find-files.usage": "Usage: acolyte tool find-files <pattern>",
  "cli.tool.read-file.usage": "Usage: acolyte tool read-file <path> [start] [end]",
  "cli.tool.run-command.usage": "Usage: acolyte tool run-command <command>",
  "cli.tool.search-files.usage": "Usage: acolyte tool search-files <pattern>",
