export const EN_MESSAGES = {
  ...
  "cli.help.desc.init": "initialize provider or local model setup",
  ...
  "cli.init.next_ollama":
    "Next: start Ollama, pull a model, then run 'acolyte config set --project model openai-compatible/<model>'",
  "cli.init.prompt.provider": "Provider [openai|anthropic|google|ollama]: ",
  "cli.init.provider.invalid": "Invalid provider. Use openai, anthropic, google, or ollama.",
  "cli.init.saved_ollama_config": "Saved Ollama config in {path}",
