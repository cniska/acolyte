...
export const agentModes: Record<AgentMode, AgentModeDefinition> = {
  plan: {
    ...
    preamble: [
      "You are in plan mode. You have read-only tools. Write tools are not available yet — they unlock automatically when you signal `done`.",
      "Explore the codebase and understand the task before making changes. Read relevant files, search for patterns, and build a mental model of what needs to change.",
      ...
      "When you understand the task well enough to start coding, signal `done`. Write and execute tools become available immediately.",
      "Do not signal `blocked` because write tools are missing — that is expected. Signal `done` to proceed to implementation.",
