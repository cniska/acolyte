...
export const agentModes: Record<AgentMode, AgentModeDefinition> = {
  work: {
    ...
    preamble: [
      ...
      "Do not run lint, format, or build commands — the lifecycle runs them automatically after your edits. Use `run-tests` to validate changes against specific test files instead of running the full test suite.",
