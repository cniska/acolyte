...
export const TRACE_EVENT_CATALOG: Record<TraceEventName, TraceEventDefinition> = {
  ...
  "lifecycle.model_usage": defineEvent([
    "input_tokens",
    "output_tokens",
    "cache_read_tokens",
    "cache_write_tokens",
  ...
  "lifecycle.cancelled": defineEvent([]),
  "lifecycle.tool.call": defineEvent(["tool", "path", "offset", "limit", "paths", "pattern", "command", "cmd", "args"]),
  "lifecycle.tool.result": defineEvent(["tool", "duration_ms", "is_error", "result_chars"]),
  ...
  "lifecycle.skill.dropped": defineEvent(["skill_name", "tokens", "remaining"]),
  ...
  "lifecycle.memory.commit_scheduled": defineEvent([
    "queue_key",
    "session_id",
    "message_count",
    "output_chars",
