...
## What is the difference between `stored` and `distill`?

- `stored`: explicit Markdown memory records managed by CLI commands.
- `distill`: automatic observations/reflections extracted from conversation flow.
