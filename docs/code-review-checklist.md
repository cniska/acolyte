...
- [x] [`src/lifecycle-resolve.ts`](../src/lifecycle-resolve.ts)
...
- [x] [`src/file-toolkit.ts`](../src/file-toolkit.ts)
- [x] [`src/shell-toolkit.ts`](../src/shell-toolkit.ts)
- [x] [`src/web-toolkit.ts`](../src/web-toolkit.ts)
- [x] [`src/file-ops.ts`](../src/file-ops.ts)
- [x] [`src/git-ops.ts`](../src/git-ops.ts)
- [x] [`src/shell-ops.ts`](../src/shell-ops.ts)
- [x] [`src/web-ops.ts`](../src/web-ops.ts)
- [x] [`src/tool-utils.ts`](../src/tool-utils.ts)
...
- [x] [`src/client-factory.ts`](../src/client-factory.ts)
...
- [x] [`src/task-queue.ts`](../src/task-queue.ts)
- [x] [`src/network-host.ts`](../src/network-host.ts)
- [x] [`scripts/wait-server.ts`](../scripts/wait-server.ts)
...
- [x] [`src/cli-daemon.ts`](../src/cli-daemon.ts)
...
- [ ] [`src/client-factory.test.ts`](../src/client-factory.test.ts)
